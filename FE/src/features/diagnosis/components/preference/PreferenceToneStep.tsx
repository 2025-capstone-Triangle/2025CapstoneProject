...
import { PreferenceProgressHeader } from "./PreferenceProgressHeader";
  ...
  return (
    <>
      <div className="space-y-3 lg:hidden">
        <div className="sticky top-0 z-20 -mx-5 border-b border-[#ececec] bg-white/95 px-5 pb-2 pt-0.5 backdrop-blur sm:-mx-8 sm:px-8">
          <PreferenceProgressHeader stepIndex={stepIndex} totalSteps={totalSteps} selectedCount={selectedCount} compact />

          <div className="mb-2 mt-1">
            <div className="mb-2 inline-flex items-center rounded-full bg-black px-3 py-1.5 font-['Noto_Sans_KR'] text-[12px] text-white">
              질문 7
            </div>
            <h2 className="font-['NEXON_Football_Gothic'] text-[24px] leading-[1.3] text-black">
              샘플 사진을 취향에 맞게 조절해 주세요
            </h2>
          </div>

          <div className="relative h-full overflow-hidden rounded-[18px] border border-[#e5e5e5] bg-[#f4f4f4]">
            <div className="relative h-[min(38vh,300px)]">
              <img
                src={toneImageSrc}
                alt="tone-adjust-target"
        ...
        <div className="rounded-[20px] border border-[#e5e7eb] bg-gradient-to-b from-white to-[#fafafa] p-3 sm:p-4">
      ...
      <div className="hidden lg:grid lg:h-[min(64vh,560px)] lg:grid-cols-2 lg:items-stretch lg:gap-4">
